...
const DownNavbar: React.FC = () => {
    // Change: Removed the incorrect return type
    const path = usePathname(); // Change: Changed `let` to `const` for immutability

    function lol(event: React.MouseEvent<HTMLAnchorElement>) {
        // Change: Specified the event type
